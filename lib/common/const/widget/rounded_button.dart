...
const Color THEME_PRIMARY_COLOR = Color(0xFF37DBFF);
const Color THEME_ALERT_COLOR = Color(0xFFFF3812);
const Color THEME_ERROR_COLOR = Color(0xFFFF1111);
const Color THEME_ERROR_BG_COLOR = Color(0x33FF1111);

const Color THEME_BG_COLOR = Color(0xFF28272B);

const double UI_FONT_SIZE_M = 14;
const double UI_FONT_SIZE_S = 12;
...
class RoundedButton extends RoundedButtonNormal {
  ...
  const RoundedButton.active(
      String label,
      {
        ...
        Color backgroundColor = PRIMARY_90,
        Color borderColor = Colors.transparent,
        bool fullWidth = true,
        EdgeInsets padding = const EdgeInsets.symmetric(horizontal: 20),
        double? fontSize = UI_FONT_SIZE_M,
  ...
  const RoundedButton.edit(
      String label,
      {
        ...
        Color backgroundColor = THEME_BG_COLOR,
        Color borderColor = Colors.transparent,
        bool fullWidth = true,
  ...
  RoundedButton.kakao(
      ...
      fontSize: fontSize,
      height: height,
      icon: Image.asset('assets/img/setting/kakao_01.png', width: 20.r, height: 20.r),
  );
